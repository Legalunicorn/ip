---
name: test-ui
description: Run black-box console tests for Bingus using command and expected-output cases recorded in test/ui-test-plan.md. Use when asked to test console commands, verify program output, or run the UI test plan after a code change.
---
...
2. Run Bingus once using the test case's ordered input commands.
